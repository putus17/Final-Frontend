...
const GewogForm: React.FC<Props> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-gradient-to-br from-blue-100/50 via-white/50 to-blue-200/70 backdrop-blur-sm p-6">
      <div className="w-full max-w-3xl rounded-3xl bg-white/90 shadow-2xl border border-blue-100 overflow-hidden ring-1 ring-blue-300/20">
        
        {/* Header */}
        <div className="px-8 py-6 border-b bg-gradient-to-r from-blue-50 to-blue-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded-xl border border-blue-200 px-4 py-2 text-sm text-gray-900 shadow-sm focus:ring-2 focus:ring-blue-400 focus:outline-none"
              />
            </div>
  ...
  <label className="block text-sm font-semibold text-violet-700">Dzongkhag</label>
  <div className="relative">
    <select
      ...
      className="peer w-full appearance-none rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm text-gray-800 shadow-sm transition focus:border-violet-500 focus:ring-1 focus:ring-violet-400 focus:outline-none"
    >
    ...
    <div className="pointer-events-none absolute inset-y-0 right-3 flex items-center text-gray-400">
      ...
      >
        ...
        {/* Footer */}
        <div className="px-8 py-5 bg-blue-50 border-t border-blue-200 flex justify-end gap-4">
          <button
            onClick={onCancel}
