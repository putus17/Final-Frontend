...
const Dzongkhag = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-blue-900 via-blue-700 to-teal-600 text-white p-4 sm:p-6 overflow-auto">
      <div className="w-full max-w-7xl">
        {/* Header */}
        <div className="mx-auto p-4 sm:p-8 rounded-2xl bg-blue-900/70 backdrop-blur-md shadow-lg border border-teal-400">
