...
const Dzongkhag = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-900 via-blue-700 to-teal-600 p-4 sm:p-6 text-white">
      {/* Header */}
      <div className="max-w-5xl mx-auto p-6 sm:p-10 rounded-2xl sm:rounded-3xl bg-blue-900/70 backdrop-blur-md shadow-lg border border-teal-400">
        <div className="text-center space-y-4 sm:space-y-6">
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
            ...
            <h1 className="text-2xl sm:text-4xl font-extrabold tracking-wider drop-shadow-lg">
          ...
          <p className="text-sm sm:text-base max-w-2xl mx-auto leading-relaxed text-teal-200/90">
            Bhutan is divided into 20 administrative districts known as dzongkhags. Each dzongkhag reflects the country’s rich heritage and stunning landscapes—from lush valleys to towering mountains.
          </p>
        </div>
      </div>

      {/* Region Stats */}
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 my-6 sm:my-8">
        {regionStats.map((region) => (
          <Card key={region.name} className="bg-blue-800/60 border border-teal-400">
            <CardContent className="p-4 sm:p-6 text-teal-100">
      ...
      {/* Search & Filter */}
      <div className="bg-blue-900/70 backdrop-blur-sm border border-teal-400 p-4 sm:p-6 rounded-2xl space-y-4 sm:space-y-0 sm:flex sm:items-center sm:justify-between flex-wrap gap-4 mb-8">
        <div className="relative w-full sm:w-1/3">
          ...
          <Input
            ...
            className="w-full pl-10 pr-4 py-2 rounded-lg border border-teal-400 text-teal-900 bg-teal-100"
          />
        </div>
        ...
        <div className="flex flex-wrap gap-2 justify-center sm:justify-start flex-1">
          {regions.map((region) => (
            <button
              ...
              className={`px-3 sm:px-4 py-1.5 text-sm font-medium rounded-full ${
        ...
        <div className="w-full sm:w-auto">
          <Button
            ...
            className="w-full sm:w-auto px-4 py-2.5 text-sm font-semibold text-teal-600 border-teal-600 bg-teal-50 hover:bg-teal-200"
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-8">
        {filteredDzongkhags.map((dzongkhag) => (
          <div
            key={dzongkhag.code}
            className="relative group bg-blue-900/40 border border-teal-400 rounded-2xl p-4 sm:p-6 shadow-md hover:shadow-xl transition duration-300"
          >
      ...
      <Card className="bg-gradient-to-r from-teal-600 to-blue-700 text-white mb-8">
        <CardContent className="p-6 sm:p-8 grid grid-cols-1 sm:grid-cols-3 text-center gap-6">
          <div>
